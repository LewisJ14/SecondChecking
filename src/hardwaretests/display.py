...
def run_display_test(root, test_results, test_labels, tests_window=None):
    try:
        ...
        def prompt_result():
            ...
            ttk.Button(frame, text="Retry", width=10, style="info.TButton", command=lambda: [result_window.destroy(), run_display_test(root, test_results, test_labels, tests_window)]).pack(side="left", padx=5)
